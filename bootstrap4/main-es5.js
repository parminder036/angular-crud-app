...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
    ...
    var AddProductComponent = /*#__PURE__*/function () {
      ...
      _createClass(AddProductComponent, [{
        ...
        value: function ngOnInit() {
          ...
          if (this.id) {
            this.isEdit = true;
            this.productService.onGetProduct(this.id).subscribe(function (res) {
              _this.product = res;
            });
          }
        }
        ...
        value: function getLatestProducts() {
        ...
        value: function onSubmit(myForm) {
          ...
          var product = myForm.value;
          this.productService.createProduct(product).subscribe(function (res) {
            _this2.getLatestProducts();

            myForm.form.reset();
            console.log("Product added");
            _this2.msg = "You Added A Product!!";
          });
        }
      }, {
        key: "editProduct",
        value: function editProduct(myForm) {
          var _this3 = this;

          console.log('edit a product');
          this.productService.onUpdateProduct(this.product).subscribe(function () {
            _this3.getLatestProducts();

            console.log("Product is updated!!");
            _this3.isEdit = false;
            myForm.form.reset();
            _this3.msg = "You Updated A Product";
          });
        }
      }]);
  ...
  function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var routes = [{
      ...
      path: 'searchProduct/add/:id',
      component: _add_product_add_product_component__WEBPACK_IMPORTED_MODULE_4__["AddProductComponent"]
    }, {
      path: 'searchProduct/edit/:id',
      component: _add_product_add_product_component__WEBPACK_IMPORTED_MODULE_4__["AddProductComponent"]
    }, {
      path: 'searchProduct',
      ...
      function HomeComponent() {
        ...
        this.chartOptions = {
          ...
          series: [{
            type: 'pie',
            name: 'share',
            data: [['availableProducts', 25], ['unusedProducts', 75]]
          }]
        };
      }
  ...
  function srcAppProductServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var ProductService = /*#__PURE__*/function () {
      ...
      _createClass(ProductService, [{
        key: "onGetProducts",
        value: function onGetProducts() {
          return this.http.get('http://localhost:3000/products');
        }
      }, {
        key: "onGetProduct",
        value: function onGetProduct(id) {
  ...
  function srcAppSearchProductSearchProductComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var SearchProductComponent = /*#__PURE__*/function () {
      function SearchProductComponent(productService, router) {
      ...
      _createClass(SearchProductComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.productService.onGetProducts().subscribe(function (res) {
            _this4.products = res;
          });
        }
      }, {
        ...
        value: function deleteProduct(product) {
          ...
          this.productService.onDeleteProduct(product).subscribe(function (res) {
        ...
        value: function search() {
          ...
          if (this.title === "") {
            ...
            this.products = this.products.filter(function (x) {
              return x.title.toLocaleLowerCase().match(_this6.title.toLocaleLowerCase());
            });
          }
        }
      }, {
    ...
    SearchProductComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./src/app/search-product/search-product.component.css"))["default"]]
  ...
  function srcEnvironmentsEnvironmentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var environment = {
      production: false,
      baseUrl: 'http://localhost:8080/products-ut-wo-db/rest/' // baseUrl: 'http://localhost:8081/products-ut-wo-db/rest/'
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\workspace-UT-Angular8-SEPT2020\VinylProjectVersion2\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
